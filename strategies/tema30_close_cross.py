...
if ( close > tema30 ) and ( close_y < tema30_y ):
    print_log ( 'tema30_close_cross.py', 'LONG', [ 'Close', 'TEMA_30', 'tema30_Close_cross' ] , backtest_strategy ( ticker , '2020-01-01' ) )

if ( close < tema30 ) and ( close_y > tema30_y ):
    print_log ( 'tema30_close_cross.py', 'SHORT', [ 'Close', 'TEMA_30', 'tema30_Close_cross' ] , backtest_strategy ( ticker , '2020-01-01' ) )
