...
if data["SMA_20"][-1] > data["SMA_50"][-1] and data["SMA_20"][-2] < data["SMA_50"][-2]:
    print_log ( '115_SMA_20_50', 'LONG', [ 'SMA_20', 'SMA_50', 'SMA_20_50_cross' ] , backtest_strategy ( ticker , '2020-01-01' ) )

if data["SMA_3"][-1] < data["SMA_50"][-1] and data["SMA_20"][-2]  > data["SMA_50"][-2]:
    print_log ( '115_SMA_20_50', 'SHORT', [ 'SMA_20', 'SMA_50', 'SMA_20_50_cross' ], backtest_strategy ( ticker , '2020-01-01' ) )
