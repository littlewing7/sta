...
if data["SMA_13"][-1] > data["SMA_34"][-1] and data["SMA_13"][-2] < data["SMA_34"][-2]:
    print_log ( '115_SMA_13_34', 'LONG', [ 'SMA_13', 'SMA_34', 'SMA_13_34_cross' ] , backtest_strategy ( ticker , '2020-01-01' ) )

if data["SMA_3"][-1] < data["SMA_34"][-1] and data["SMA_13"][-2]  > data["SMA_34"][-2]:
    print_log ( '115_SMA_13_34', 'SHORT', [ 'SMA_13', 'SMA_34', 'SMA_13_34_cross' ], backtest_strategy ( ticker , '2020-01-01' ) )
