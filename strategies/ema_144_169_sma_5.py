...
if (close.iloc[-1] > sma_5.iloc[-1]) and (ema_144.iloc[-1] > ema_169.iloc[-1] ):
    print_log ( 'ema_144_169_sma_5.py', 'LONG', [ 'EMA_144', 'EMA_169', 'SMA_5' ] , backtest_strategy ( ticker , '2020-01-01' ) )
...
if (close.iloc[-1] < sma_5.iloc[-1]) and (ema_169.iloc[-1] > ema_144.iloc[-1] ):
    print_log ( 'ema_144_169_sma_5.py', 'SHORT', [ 'EMA_144', 'EMA_169', 'SMA_5' ] , backtest_strategy ( ticker , '2020-01-01' ) )
